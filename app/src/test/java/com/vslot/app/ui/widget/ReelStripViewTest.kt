...
class ReelStripViewTest {
    ...
    fun `spin hot path binds one renderer without image resource calls`() {
        ...
        assertTrue(fragmentSource.contains("const val REEL_SPIN_COLUMNS_PER_TICK = 2"))
        assertTrue(fragmentSource.contains("const val REEL_SPIN_MIN_RENDER_INTERVAL_MS = 60L"))
