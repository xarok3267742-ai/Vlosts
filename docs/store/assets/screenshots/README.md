...
These five 1080 x 1920 RGB PNG files were captured from the minified `qa` build on the clean `Leon_API36_Clean` API 36 AVD on 2026-07-28. They show only real release-reachable application states driven by instrumentation tests; no interface layer was composed or retouched after capture.
